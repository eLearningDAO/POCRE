  ...
  return (
    <div className="sidebar">
      <ul>
        <li
          className={
            location.pathname.includes("/creations") ? "activeSidebarMenu" : ""
          }
        >
          <Link to="/creations">
            <img
              alt="menu-icon"
              src={
                location.pathname.includes("/creations")
                  ? MenuIcon2Active
                  : MenuIcon2
              }
            />
        ...
        <li
          className={
            location.pathname.includes("/invitation") ? "activeSidebarMenu" : ""
          }
        >
          <Link to="/invitation">
            <img
        ...
        <li
          className={
            location.pathname.includes("/litigation") ? "activeSidebarMenu" : ""
          }
        >
          <Link to="/litigation">
            <img
        ...
        <li
          className={
            location.pathname.includes("/wallet") ? "activeSidebarMenu" : ""
          }
        >
          <Link to="/wallet">
            <img
        ...
        <li
          className={
            location.pathname.includes("/credit") ? "activeSidebarMenu" : ""
          }
        >
          <Link to="/credit">
            <img
