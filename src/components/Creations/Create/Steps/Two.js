            ...
            <Grid container className='create-collection' bgcolor="rgba(255, 255, 255, 0.28)" border="2px dashed #F78F8A">
                ...
                <Grid xs={12} md={4}>
                    <TextField
                        ...
                        InputProps={{
                            disableUnderline: true,
                        }} className='input input-dark' fullWidth placeholder="Select.." />
                </Grid>
                ...
                <Grid xs={12} md={8} marginTop={{ xs: "0px", md: "18px" }} display="flex" gap="8px" alignItems="center">
                    ...
                    <Button className='inviteButton' style={{ width: 'fit-content', paddingLeft: '24px', paddingRight: '24px' }}><img width={17} style={{ marginRight: '10px' }} alt='invite-icon' src={InviteIcon} /> Invite</Button>
                </Grid>
            </Grid>
        </Grid>
    );
