    ...
    <div className="sidebar">
      <ul>
        <li className={location.pathname.includes('/creations') ? 'activeSidebarMenu' : ''}>
          <Link to="/creations">
            <img alt="menu-icon" src={location.pathname.includes('/creations') ? MenuIcon2Active : MenuIcon2} />
            <span>Creations</span>
          </Link>
        </li>
        ...
        <li className={location.pathname.includes('/litigation') ? 'activeSidebarMenu' : ''}>
          <Link to="/litigation">
            <img alt="menu-icon" src={location.pathname.includes('/litigation') ? MenuIcon4Active : MenuIcon4} />
            <span>Litigation</span>
          </Link>
        </li>
        <li className={location.pathname.includes('/wallet') ? 'activeSidebarMenu' : ''}>
          <Link to="/wallet">
            <img alt="menu-icon" src={location.pathname.includes('/wallet') ? MenuIcon5Active : MenuIcon5} />
            <span>Wallet</span>
          </Link>
        </li>
