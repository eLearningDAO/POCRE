...
export default function LitigationClosed() {
  ...
  console.log("LitigationClosed", { user });
  const next = () => {
    ...
    <Grid item xs={12}>
      <Grid item xs={12}>
        <Typography className="litigationCloseTitle" variant="h6">
          Litigation- I want to reclaim my authorship of this media
        </Typography>
      </Grid>
      ...
      >
        <div className="carousel-container">
          {slideNumber % 2 === 0 ? (
            <>
              ...
              />
              <UserCard
                username="Kelton Price"
                imageUrl={`https://i.pravatar.cc/50?img=${Math.random()}`}
                totalCreationsAuthored={1}
              />
            </>
          ) : (
            <>
              <UserCard
                username="Leone Dach"
                imageUrl={`https://i.pravatar.cc/50?img=${Math.random()}`}
                totalCreationsAuthored={5}
              />
              <UserCard
                username="Jewell Purdy"
                imageUrl={`https://i.pravatar.cc/50?img=${Math.random()}`}
                totalCreationsAuthored={8}
              />
            </>
          )}
        ...
        <Button className="btn btn-primary-outlined" style={{ margin: "auto" }}>
          See More
        </Button>
      </Grid>
    </Grid>
