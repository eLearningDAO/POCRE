...
router.route('/').post(auth(), validate(statusValidation.createStatus), statusController.createStatus);

router
  .route('/:status_id')
  .get(validate(statusValidation.getStatus), statusController.getStatusById)
  .patch(auth(), validate(statusValidation.updateStatus), statusController.updateStatusById)
  .delete(auth(), validate(statusValidation.deleteStatus), statusController.deleteStatusById);
